...
let links = [[ 1.570, -1.570,  0.000], // "theta" rotation in z
             ...
             [ 0.000,  0.000,  0.000, 2]];// kind of link
...
bot.config([ q0._data[0][0], q0._data[1][0], q0._data[2][0]]);//aceitar vetor coluna
